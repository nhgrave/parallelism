...
public class EnviadorBlocos {
    ...
    public class EnviadorBlocosThreadListner extends Thread {

        int srcCornerX, srcCornerY, dstCornerX, dstCornerY;
        byte[] tBuffer;

        public EnviadorBlocosThreadListner(int srcCornerX, int srcCornerY, int dstCornerX, int dstCornerY) {
    ...
    private void sendImageBlocks() {
        ...
        for (int y = 0; y < blocosY; y++) {
            for (int x = 0; x < blocosX; x++) {
                ...
                new EnviadorBlocosThreadListner(srcCornerX, srcCornerY, dstCornerX, dstCornerY).start();
            }
        }
    }
